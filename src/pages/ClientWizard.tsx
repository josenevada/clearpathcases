...
const ClientWizard = () => {
  ...
  const isVehicle = currentItem && /\b(vehicle|car|auto|title|registration)\b/i.test(currentItem.label);
  ...
  return (
    <div className="min-h-[100dvh] flex flex-row">
      ...
      <div className="flex-1 flex items-start sm:items-center justify-center px-6 lg:px-12 pt-4 sm:pt-0 pb-24">
      ...
      {currentItem && (
        <button
          ...
          className="fixed bottom-32 right-4 z-50 sm:bottom-6 sm:right-6 flex items-center gap-2 px-4 py-3 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/25 hover:bg-primary/90 active:scale-95 transition-all duration-150 font-medium text-sm"
        >
